  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved node as @node" do
        ...
        post :create, {:node => { "router" => "invalid value" }}, valid_session
        assigns(:node).should be_a_new(Node)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested node" do
        ...
        Node.any_instance.should_receive(:update).with({ "router" => "" })
        put :update, {:id => node.to_param, :node => { "router" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the node as @node" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Node.any_instance.stub(:save).and_return(false)
        put :update, {:id => node.to_param, :node => { "router" => "invalid value" }}, valid_session
        assigns(:node).should eq(node)
      end
