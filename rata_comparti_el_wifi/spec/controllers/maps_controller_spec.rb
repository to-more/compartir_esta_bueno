  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved map as @map" do
        ...
        post :create, {:map => { "address" => "invalid value" }}, valid_session
        assigns(:map).should be_a_new(Map)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested map" do
        ...
        Map.any_instance.should_receive(:update).with({ "address" => "MyString" })
        put :update, {:id => map.to_param, :map => { "address" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the map as @map" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Map.any_instance.stub(:save).and_return(false)
        put :update, {:id => map.to_param, :map => { "address" => "invalid value" }}, valid_session
        assigns(:map).should eq(map)
      end
